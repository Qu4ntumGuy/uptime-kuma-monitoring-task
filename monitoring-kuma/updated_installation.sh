...
# Create root user and database
echo "Creating root user and database..." >> ~/errors.txt
sudo mysql -e "CREATE USER 'root'@'%' IDENTIFIED BY 'root@123';"
...
sudo mysql -e "USE kuma; CREATE TABLE websites (id INT AUTO_INCREMENT PRIMARY KEY, ip VARCHAR(255) UNIQUE, name VARCHAR(255), url VARCHAR(255));"
